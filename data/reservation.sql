...
CREATE UNIQUE INDEX uniq_f6b4fb29aa08cb10 ON public.membre USING btree (login);

CREATE INDEX idx_f6b4fb29d60322ac ON public.membre USING btree (role_id);

CREATE UNIQUE INDEX uniq_f6b4fb29e7927c74 ON public.membre USING btree (email);
